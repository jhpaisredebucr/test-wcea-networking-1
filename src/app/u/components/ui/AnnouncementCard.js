    ...
    return (
        <div>
            <div className="p-5 rounded-lg shadow-[0_0_4px_rgba(0,0,0,0.15)] bg-white">
                <Profile first_name="WCEA" last_name="" profile="logo_ett0lg"><p className="text-sm text-gray-400">{formatDistanceToNow(new Date(announcements?.created_at), { addSuffix: true })}</p></Profile>
