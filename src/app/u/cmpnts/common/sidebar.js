...
export default function SideBar({ page, setPage, userData, role="member" }) {
    ...
    return (
        <div className="fixed flex flex-col justify-between left-0 top-0 h-[calc(100vh-60px)] mt-15 w-56 bg-white p-6">
            ...
            {role == "member" &&
                <div>
                    ...
                    <p className="font-semibold">{userData?.referredBy?.username}</p>
                </div>
            }
        </div>
    )
