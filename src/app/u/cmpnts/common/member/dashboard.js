...
export default function DashboardMember({dashboardData, userData}) {
    ...
    return (
        <div className="grid grid-cols-4 auto-rows-[130px] gap-5 w-full">
            <Card title="Available Balance" value={`₱${dashboardData?.totalBalance}`} valueSize="text-4xl" clas info="" rowSpan="row-span-2" colSpan="col-span-2"><button className="p-2 bg-blue-400 rounded-lg">Withdraw</button></Card>
