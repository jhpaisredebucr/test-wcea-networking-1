...
export default function Navbar() {
    ...
    function About() {
        router.push("/landing-page/about")
    }
    ...
    function Contacts() {
        router.push("/landing-page/contacts")
    }
    ...
    return (
        <nav className="flex w-screen h-14 items-center justify-between px-5">
            ...
            <div>
                <button onClick={Home} className="mx-2 p-2 rounded-2xl text-gray-600 hover:bg-gray-100">Home</button>
